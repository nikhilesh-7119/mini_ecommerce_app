...
class HomeController extends GetxController {
  ...
  Future<void> loadProducts({bool force = false}) async {
    ...
    try {
      ...
      errorMessage.value = 'No internet and no saved data. Connect to the internet and refresh.';
    } catch (e) {
      errorMessage.value = 'Something went wrong. Connect to the internet and refresh.';
    } finally {
